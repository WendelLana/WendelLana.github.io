...
<body>
    ...
    <main>
        <div class="col-md-12 order-md1">
            <div class="card">
                <div class="card-header border-dark text-white" style="background-color: #13133a;font-weight: bold;">Cursos em
                    Quarentena</div>
                <div class="card-body">
                    <div class="container animated bounceInUp">
                        <div class="row">
                            <div class="view overlay col-md-2">
                            ...
                            <div class="view overlay col-md-2">
                                <a style="color: white; text-decoration: none;"
                                    href="https://casadosaber.com.br/sp/">
                                    <img class="img-fluid img-thumbnail" src="casasaber.png" alt="Casa do Saber Logo">
                                    <button class="btn text-light" style="background-color: #13133a;">Casa do Saber Cursos
                                        Gratuitos</a>
                                </a>
                            </div>
                            <div class="view overlay col-md-2">
                                <a style="color: white; text-decoration: none;"
                                    ...
                                    <button class="btn text-light" style="background-color: #13133a;">Linkedin Sobre Trabalho Remoto</a>
                                </a>
                            </div>  
                            <div class="view overlay col-md-2">
                                <a style="color: white; text-decoration: none;"
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <iframe class="col-md-2" style="height: 340px" marginwidth="0" marginheight="0" scrolling="no" frameborder="0"
                            ...
                            <div class="col col-md-2">
                                <a class="btn btn-warning btn-outline-dark" href="https://amzn.to/38WyxGQ">Ver Destaques</a><br>
                                <a class="btn btn-warning btn-outline-dark" href="https://amzn.to/3b92Knw">E-books grátis</a>
