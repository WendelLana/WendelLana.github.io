...
<body>
    <header>
        <div
            ...
            <a routerlinkactive="hide-login" class="btn btn-outline-primary" href="https://amzn.to/38WyxGQ">Amazon Destaques</a>
        </div>
    </header>
    <main>
                ...
                <div class="card-body">
                    <div class="container animated bounceInUp">     
                        ...
                        <div class="col col-md-2">
                            <button type="button" class="btn btn-warning btn-outline-dark"><a href="https://amzn.to/3a78ONe">Acessar Amazon</a></button>
                        </div>
                    </div>                
                    </div>
                </div>
